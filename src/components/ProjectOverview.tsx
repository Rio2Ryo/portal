    ...
    <section id="project-overview" className="py-32 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {/* Left Column - 建設すればするほど地球が健康になる */}
          <div className="bg-gray-900/50 backdrop-blur-md border border-green-500/20 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-white text-center mb-8">建設すればするほど地球が健康になる</h3>
          ...
          {/* Right Column - 地球最初の生命体が人類を豊かにする */}
          <div className="bg-gray-900/50 backdrop-blur-md border border-green-500/20 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-white text-center mb-8">地球最初の生命体が人類を豊かにする</h3>
