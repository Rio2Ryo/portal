...
export default function TeamMembers() {
  const teamMembers = [
    ...
    },
    {
      ...
      image: "/matsuura-ryosuke-new-CGvsNVEI.jpeg",
    ...
    },
    {
      ...
      image: "/kumaki-kei-new-vP5LbiIL.jpeg",
      company: "dotpb株式会社",
    ...
    <section id="team" className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <span className="inline-block bg-blue-500/20 border border-blue-500/50 text-blue-400 px-4 py-2 rounded-full text-sm mb-4">
            2. チームメンバー
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-xl p-8 hover:border-emerald-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className={`font-semibold mb-4 ${member.companyColor}`}>
                    {member.company} {member.title.includes('代表取締役') ? '代表取締役' : '創設者・最高技術責任者'}
                    {member.title.includes('ASEAN') && (
                      <span className="block text-sm">/ ASEAN持続可能農業アドバイザー</span>
                    )}
                  </p>
