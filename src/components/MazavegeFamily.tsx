      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mx-auto border border-green-700 rounded-lg lg:p-4 bg-black/40" style={{ width: '95%', maxWidth: '1200px' }}>
                ...
                <div className="flex flex-row gap-2 h-full lg:hidden">
                  ...
                  <div className="flex-1 flex flex-col gap-3 justify-center">
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="w-[55%]">
                        <div className="text-white text-[8px] flex items-start leading-[1.2]">
                        ...
                        <div className="text-white text-[8px] flex items-start leading-[1.2] mt-0.5">
                          <span className="text-green-600 mr-0.5 flex-shrink-0 text-[8px]">✓</span>
                    ...
                    <div className="flex flex-row gap-2">
                      <div className="w-[45%]">
                        ...
                        <p className="text-white text-[8px] leading-[1.2]">{t({ JP: "48種類の栄養素を一度に", EN: "48 different nutrients at once." })}</p>
                      </div>
                      <div className="w-[55%]">
          ...
          <div className="mt-5 lg:mt-12 mb-5 lg:mb-12 text-center space-y-2">
            <p className="text-white text-[8px] sm:text-xs lg:text-sm">
